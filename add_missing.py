...
wfcConfigFile = '/home/sysop/Programs/wfcatalog/collector/config.json' # WFCatalog collector config.json file
wfcCollector = '/home/sysop/Programs/wfcatalog/collector/WFCatalogCollector.py' # WFCatalogCollector.py script
...
subprocess.run(['python3', wfcCollector] + collectorOptions)
